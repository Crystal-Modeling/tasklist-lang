...
export interface TaskListSemanticDomain extends SemanticDomain, QueriableTaskListSemanticDomain {
    ...
    getValidatedTransitions(model: ast.Model): Stream<Validated<Transition & TransitionIdentifiedProperties>>
...
class DefaultTaskListSemanticDomain implements TaskListSemanticDomain {
    ...
    */
    ...
    public getValidatedTransitions(model: ast.Model): Stream<Validated<Transition & TransitionIdentifiedProperties>> {
        return this.getValidatedTasks(model)
            .flatMap(task => this._validatedTransitionsByTask.get(task) ?? [])
