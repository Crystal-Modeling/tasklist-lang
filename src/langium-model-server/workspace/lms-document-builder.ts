...
export class DefaultLmsDocumentBuilder<SM extends id.SemanticIdentifier, II extends IdentityIndex<SM>, D extends LmsDocument> implements LmsDocumentBuilder {
