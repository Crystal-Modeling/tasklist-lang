...
import type { Creation, CreationParams, CreationResponse } from './model'
...
export interface AddModelHandler<T extends SemanticIdentity = SemanticIdentity> {
    ...
    addModel(rootModelId: string, newModel: Creation<T>, creationParams: CreationParams): MaybePromise<CreationResponse> | undefined
}
